...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      scbody.innerHTML = ' <div class="sc-week"> </div> <div class="sc-days"> </div><div style="clear:both;"></div>';
        ...
        if (data) {
          daysElement.forEach(function (v, i) {
            ...
            if (data[year + '-' + currentmonth + '-' + day]) {
              v.classList.add('sc-' + datas[year + '-' + currentmonth + '-' + day]);
			  v.querySelector('.lunar-day').innerHTML = data[year + '-' + currentmonth + '-' + day];
            } else {
              v.classList.remove('sc-' + datas[year + '-' + currentmonth + '-' + day]);
